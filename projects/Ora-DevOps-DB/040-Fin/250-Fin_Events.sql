...
ALTER TABLE Fin_Events ADD CONSTRAINT Fin_Events_fk11 FOREIGN KEY (Cause_ID) REFERENCES Fin_Event_Cause (id) ON DELETE SET NULL;

ALTER TABLE Fin_Events ADD CONSTRAINT Fin_Events_fk16 FOREIGN KEY (Effect_ID) REFERENCES Fin_Event_Effect (id) ON DELETE SET NULL;
