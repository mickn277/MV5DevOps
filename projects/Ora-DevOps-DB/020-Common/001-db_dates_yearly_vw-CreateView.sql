...
SELECT ADD_MONTHS(to_date('01-JAN-4712 BC', 'DD-MON-YYYY AD'), (12*LEVEL)-12) AS YEAR_DT
FROM dual
...
SELECT 
    TO_CHAR(MIN(year_dt), 'DD-MON-YYYY AD') MIN_DATE_VALUE,
    TO_CHAR(MAX(year_dt), 'DD-MON-YYYY AD') MAX_DATE_VALUE, 
    count(*) TOTAL_DATES
